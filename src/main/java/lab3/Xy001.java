...
public class Xy001 {
    ...
    public static void main(String[] args) {
        ...
        Dataset<Row> df = spark.read()
                ...
                .load("src/main/resources/lab3/xy-001.csv");
        ...
        plot(x, y, lrModel, "Linear Regression", Xy001::realFunction);
        ...
        LinearRegression lr10 = new LinearRegression()
                ...
                .setFeaturesCol("features")
                .setLabelCol("Y");
        LinearRegressionModel lrModel10 = lr10.fit(df_trans);
        plot(x, y, lrModel10, "Linear Regression RegParam(10)", Xy001::realFunction);
        System.out.println("r2: " + lrModel10.summary().r2());
        ...
        LinearRegression lr20 = new LinearRegression()
                ...
                .setFeaturesCol("features")
                .setLabelCol("Y");
        LinearRegressionModel lrModel20 = lr20.fit(df_trans);
        plot(x, y, lrModel20, "Linear Regression RegParam(20)", Xy001::realFunction);
        System.out.println("r2: " + lrModel20.summary().r2());
        ...
        LinearRegression lr50 = new LinearRegression()
                ...
                .setFeaturesCol("features")
                .setLabelCol("Y");
        LinearRegressionModel lrModel50 = lr50.fit(df_trans);
        plot(x, y, lrModel50, "Linear Regression RegParam(50)", Xy001::realFunction);
        System.out.println("r2: " + lrModel50.summary().r2());

        // setRegParam(100)
        LinearRegression lr100 = new LinearRegression()
                .setMaxIter(10)
                .setRegParam(100)
                .setElasticNetParam(0.8)
                .setFeaturesCol("features")
                .setLabelCol("Y");
        LinearRegressionModel lrModel100 = lr100.fit(df_trans);
        plot(x, y, lrModel100, "Linear Regression RegParam(100)", Xy001::realFunction);
        System.out.println("r2: " + lrModel100.summary().r2());
